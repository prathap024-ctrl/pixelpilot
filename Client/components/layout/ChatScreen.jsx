...
export const ChatScreen = ({ messages, regenerate, status }) => {
    ...
    return (
        <div className="max-w-[45rem] mx-auto relative size-full rounded-lg md:h-[calc(100vh-8.5rem)] top-16 md:top-0 h-[calc(100dvh-12rem)]">
            <div className="flex flex-col h-full z-50">
                <Conversation>
                    <ConversationContent>
                        ...
                        {status === 'submitted' && <LoaderFive text="⚡ Generating..." />}
                    </ConversationContent>
                    <ConversationScrollButton />
                </Conversation>
            </div>
